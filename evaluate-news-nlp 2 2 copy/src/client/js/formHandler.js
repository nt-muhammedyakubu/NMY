    ...
    if (Client.checkUrl(url) === true) {
        ...
        fetch('https://localhost:8080/meaningcloud-api', {
            ...
            .then((allData) => {
                ...
                document.getElementById('subjectivity').innerHTML = `Confidence: ${allData.subjectivity}`;
                document.getElementById('objectivty').innerHTML = `objectiviity: ${allData.objectivity}`;
            })
